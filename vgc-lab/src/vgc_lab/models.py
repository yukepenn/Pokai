"""Neural models: team value model and team matchup model.

This module consolidates:
- team_value_model.py: Neural team value model for offline learning
- team_matchup_model.py: Neural team matchup model for pairwise win probability prediction
"""
...
from .dataio import TeamMatchupRecord, iter_team_matchup_records
